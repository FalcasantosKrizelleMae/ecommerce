<div class="container my-5 ">
     <p class="text-center pt-5 my-5 fs-3 lead">MOST POPULAR</p>
    ...
    <div class="row">
     ...
     <div class="d-flex justify-content-center mt-5">
          <a href="pages/all_products.php"><button class="btn btn-outline-dark rounded-pill px-5 see-more" > SEE MORE</button></a>
     </div>
</div>