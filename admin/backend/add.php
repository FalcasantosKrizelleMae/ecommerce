<?php 
    ...
    if(isset($_POST['add_product'])){
        ...
        if (!mysqli_query($con, "insert into items values('$id', '$destination_name', '$destination_name2', '$_POST[item_name]', '$_POST[description]', '$_POST[price]', '$_POST[dimension]','$_POST[category]', CURRENT_TIME());")) {
